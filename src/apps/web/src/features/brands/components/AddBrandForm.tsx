  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader>
        ...
        <CardDescription>
          {BRANDS_COPY.addBrand.description}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {createBrand.isError && (
            <Alert variant="destructive">
              <AlertDescription>
                {createBrand.error instanceof Error ? createBrand.error.message : DISCOVERY_COPY.errors.createBrandFailed}
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="space-y-2">
            ...
            <Input id="name" placeholder={BRANDS_COPY.addBrand.namePlaceholder} {...register("name")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="websiteUrl" placeholder={BRANDS_COPY.addBrand.urlPlaceholder} {...register("websiteUrl")} />
