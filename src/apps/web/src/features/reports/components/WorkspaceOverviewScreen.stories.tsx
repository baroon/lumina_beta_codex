...
const depthFixture: WorkspaceDepthDto = {
  ...
  activityHeatmap: {
    ...
    columns: ["May 1", "May 8", "May 15", "May 22", "May 29"],
    cells: [
      { row: "ChatGPT", column: "May 1", value: 10 },
      { row: "ChatGPT", column: "May 8", value: 14 },
      { row: "ChatGPT", column: "May 15", value: 12 },
      { row: "ChatGPT", column: "May 22", value: 16 },
      { row: "ChatGPT", column: "May 29", value: 6 },
      { row: "Gemini", column: "May 8", value: 8 },
      { row: "Gemini", column: "May 15", value: 10 },
      { row: "Gemini", column: "May 22", value: 11 },
      { row: "Gemini", column: "May 29", value: 4 },
      { row: "Claude", column: "May 1", value: 3 },
      { row: "Claude", column: "May 15", value: 9 },
      { row: "Claude", column: "May 29", value: 9 },
    ],
  },
  topicHeatmap: {
