      ...
      <PageHeader title={data.topicName} description={copy.subtitle}>
        <Button
          ...
          onClick={() => {
            ...
            setNotice(copy.detail.reportNotice.replace("{topic}", data.topicName));
          }}
        >
        ...
        <Button
          ...
          size="sm"
          onClick={() => {
            exportScanTopicDetailPackage(data);
            setNotice(copy.detail.exportNotice.replace("{topic}", data.topicName));
          }}
        >
...
function exportScanTopicDetailPackage(data: ScanTopicDetailDto) {
  const payload = {
    packageType: "scan-topic-detail-report",
    ...
    topCitedSources: data.topCitedSources,
    followUps: [
      {
        label: REPORTS_COPY.topics.backToResults,
        route: `/scans/${data.scanRunId}/results`,
      },
      {
        label: REPORTS_COPY.topics.title,
  ...
  anchor.href = url;
  anchor.download = `scan-topic-${data.topicId}.json`;
  anchor.click();
